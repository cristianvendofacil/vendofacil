    ...
    return (
      <main style={pageWrap}>
        <div style={pageContainer}>
          <a href="/clasificados" style={backStyle}>
        ...
        <div style={topGrid}>
          ...
          >
            ...
            <div style={{ marginTop: 12 }}>
              <FavoriteButton itemType="classified" itemId={item.id} />
            </div>

            <div style={trustBox}>
              <div style={trustTitle}>Compra con claridad</div>
              <div style={trustText}>
                Pregunta por el estado real del producto, coordina bien la entrega
                y verifica detalles antes de concretar la operación.
              </div>
            </div>
          </aside>
        </div>
